...
export const BOSS = {
  ...
  /** once hovering, the boss heaves vertically between its hover line and this far below it — diving in toward the city and rising back out, on top of the side-to-side drift */
  bobAmplitudePx: 90,
  /** how fast the vertical heave travels (px/sec) — a slow menacing rise and fall */
  bobSpeedPxPerSec: 55,
...
export const GRAVITON = {
  ...
  /** the well's pull reach = the gun's range × this — a tight vortex, not a wide bubble */
  radiusRangeFraction: 0.13,
  /** how hard invaders are dragged toward the center (px/sec) — ranks pull harder */
  pullSpeedBase: 75,
  pullSpeedPerLevel: 28,
  /** the well is a projectile fired from a gun — this is how fast it streaks up-field (px/sec) */
